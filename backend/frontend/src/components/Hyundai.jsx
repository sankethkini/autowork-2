...
export default class hyundai extends React.Component{
   ...
   async myFunction(){
               let url1="http://127.0.0.1:8000/apih/?&loc="+Number(this.state.loc)+"&yr="+Number(this.state.yr)+"&kd="+Number(this.state.kd)+"&ft="+Number(this.state.ft)+"&tr="+Number(this.state.tr)+"&ot="+Number(this.state.ot)+"&ml="+Number(this.state.ml)+"&eng="+Number(this.state.eng)+"&po="+Number(this.state.po)+"&st="+Number(this.state.st)+"&np="+Number(this.state.np)+"&md="+Number(this.state.md);
        ...
        <Form onSubmit={this.mySubmitHandler}>
            ...
            <FormGroup>
                ...
                <Input id="model" name="md" type="select" onChange={this.myChangeHandler}>
                    ...
                    <option value="2">Grand i10</option>
                    <option value="3">i10</option>
                    <option value="4">Verna</option>
                </Input>
            </FormGroup>
            <FormGroup>
